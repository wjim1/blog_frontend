    ...
    <div class="container">
      <nav class="navbar px-0 py-1 text-14 navbar-expand-lg navbar-light">
        <router-link :to="{ name: 'home' }" class="navbar-brand text-22 d-flex align-items-center antialiased">
          <img class="mr-2 avatar-40" src="/yike.svg" alt="一刻社区">Blog<span class="text-14 text-muted ml-1">| wjim's Blog </span><sup class="ml-1 text-10 text-danger"> Beta</sup> </router-link>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav flex-row align-items-center justify-content-center py-sm-2 py-md-0 mx-auto">
            ...
            <router-link :to="{ name: 'nodes.show' }" exact tag="li" class="nav-item">
              <a href="javascript:void(0);" class="nav-link">讨论</a>
            </router-link>
            <li class="nav-item">
              <a class="nav-link" href="https://easywechat.com?utm_source=yike.io">问答</a>
            </li>
            <li class="nav-item">
              <nav-search />
            </li>
